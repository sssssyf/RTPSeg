...
def parse_config():
    ...
    parser.add_argument('--config_path', default='config/RTPSegNet.yaml')
    # training
    parser.add_argument('--log_dir', type=str, default='RTPSegNet', help='log location')
    ...
    parser.add_argument('--model_3d',type=str, default='SPVCNN', help='chosee model_3d')
    # testing
    ...
    #parser.add_argument('--checkpoint', type=str, default='/data/syf/projects/2DPASS-three-modalities/2DPASS-main/logs/PIR/2DPASS-point_image_infra/train32/checkpoints/epoch=168-step=40998.ckpt', help='load checkpoint')
    # debug
...
if __name__ == '__main__':
    ...
    model_file = importlib.import_module('network.' + configs['model_params']['model_architecture'])   #load arch.py
